...
ID_Decoder <- read_csv("data/processed/ID_Decoder.csv")
...
# Merge onto ID_Decoder
taq_data_ID <- ID_Decoder %>% 
...
taq_data_ID_either <- taq_data_ID %>% 
  # CMY
...
taq_data_ID_either <- taq_data_ID_either %>% 
...
write_csv(x = taq_data_ID_either, path = "data/processed/Taq_tidy.csv")
