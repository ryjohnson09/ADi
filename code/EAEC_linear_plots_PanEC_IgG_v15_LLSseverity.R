#####################################################
# Name: EAEC_linear_plot_PanEC_IgG_v15_LLSseverity.R
# Author: Ryan Johnson
...
## Save Plots -----------------------------------------------------------
ggsave(plot = PanEC_IgG_plot, "results/figures/EAEC_linear_PanEC_IgG_v15_LLSseverity.png", width = 14, height = 8)
